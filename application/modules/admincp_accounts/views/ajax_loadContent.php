<div class="content_table">
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			...
			<th width="150" class="th_left" onclick="sort('group_id')"><div id="group_id" class="sort icon_no_sort">Group</div></th>
		...
		<tr class="item_row<?=$i?> <?php ($k%2==0) ? print 'row1' : print 'row2' ?>">
			...
			<td class="th_left"><a href="<?=PATH_URL.'admincp/'.$module.'/update/'.$v->id?>"><?=$v->username?></a></td>
			<td class="th_left"><?php if($v->custom_permission==1){ ?><span style="color: #ff9900"><?=$v->group_name?></span><?php }else{ print $v->group_name; } ?></td>
