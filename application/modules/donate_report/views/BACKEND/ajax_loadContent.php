<div class="content_table">
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		...
		<tr class="item_row<?=$i?> <?php ($k%2==0) ? print 'row1' : print 'row2' ?>">
			...
			<td width="100" class="th_left">
				<?php 
				if($servers) 
				{
					foreach ($servers as $key => $value) {
						if($value->id == $v->server_id){
			...
			<td class="th_left"><?php if($v->payment_type == 1) echo "Thẻ Cào"; else echo "ATM";?></td>
			<td class="th_left"><?php echo $v->payfrom;?></td>
