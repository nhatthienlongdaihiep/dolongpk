<div class="content_table">
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
            ...
            <th class="th_left" onclick="sort('link')"><div id="title" class="sort icon_no_sort">Link</div></th>
		...
		<tr class="item_row<?=$i?> <?php ($k%2==0) ? print 'row1' : print 'row2' ?>">
            ...
            <td class="th_left"><a href="<?=PATH_URL.'admincp/'.$module.'/update/'.$v->id?>"><?=$v->link?></a></td>
