<div class="content_table">
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			...
			<th class="th_left" onclick="sort('name')"><div id="name" class="sort icon_no_sort">Module</div></th>
			<th width="70" onclick="sort('status')"><div id="status" class="sort icon_no_sort">Action</div></th>
		...
		<tr class="item_row<?=$i?> <?php ($k%2==0) ? print 'row1' : print 'row2' ?>">
			...
			<td class="td_center" id="loadStatusID_<?=$v->id?>"><a href="javascript:void(0)" onclick="updateStatus(<?=$v->id?>,<?=$v->status?>,'<?=$module?>')"><?php ($v->status==0) ? print 'Install' : print 'Uninstall' ?></a></td>
